    ...
    decideWhichToRender(){
        if(this.props.userPage){
            return <div className="card" key={this.props.outfits.id}>
                ...
                <img sizes="293px" src={this.props.outfits.img_url} alt="cool outfit goes here" />
            ...
            return <div className="card" key={this.props.outfits.outfit.id}>
                {/* <div className="card-content"> */}
                <img sizes="293px" src={this.props.outfits.outfit.img_url} alt="cool outfit goes here" />
